            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
                  ...
                  <span className="text-clearcause-primary">
                    Track every dollar
                  </span>
                  , see the impact.
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link to="/how-it-works">
                    <Button
                      variant="outline"
                      className="text-clearcause-primary hover:text-clearcause-primary border-clearcause-primary hover:border-clearcause-primary px-8 py-6"
                    >
                      How It Works
                    </Button>
                  </Link>
              ...
              <div className="relative">
                ...
                <div className="absolute -right-4 -bottom-6 bg-white p-4 rounded-lg shadow-lg w-48">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-clearcause-success h-2 rounded-full"
                      style={{ width: "75%" }}
                    ></div>
                  </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 text-center">
              <Link
                to="/how-it-works"
                className="inline-flex items-center text-clearcause-primary hover:text-clearcause-secondary font-medium"
              >
        ...
        <section className="py-16 bg-clearcause-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-end mb-10">
              ...
              <Link
                to="/campaigns"
                className="text-clearcause-primary hover:text-clearcause-secondary font-medium flex items-center"
              >
                View all campaigns
